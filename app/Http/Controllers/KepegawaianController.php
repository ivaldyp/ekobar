...
class KepegawaianController extends Controller
{
	...
	public function pegawaiall(Request $request)
	{
		...
		$employees = DB::select( DB::raw("  
					SELECT id_emp, nrk_emp, nip_emp, nm_emp, a.idgroup as idgroup, tgl_lahir, jnkel_emp, tgl_join, status_emp, tbjab.idjab, tbjab.idunit, tbunit.nm_unit, tbunit.child, d.nm_lok from biroekodt.dbo.emp_data as a
	...
	public function pegawaitambah()
	{
		...
		return view('pages.birekokepegawaian.pegawaitambah')
				->with('id_emp', $id_emp)
	...
	public function pegawaiubah(Request $request)
	{
		...
		return view('pages.birekokepegawaian.pegawaiubah')
				->with('id_emp', $id_emp)
	...
	public function forminsertpegawai(Request $request)
	{
		...
		$id_emp = explode(".", Emp_data::where('sts', 1)->max('id_emp'));
		if (is_null($id_emp)) {
			$id_emp = explode(".", "1.21.515.21001");
		}
	...
	public function strukturorganisasi()
	{
		...
		return view('pages.birekokepegawaian.struktur');
	}
	...
	public function statusdisposisi()
	{
		...
		// 						SELECT top 1 id_emp, nrk_emp, nip_emp, nm_emp, tbjab.idjab, tbjab.idunit, tbunit.child, tbunit.nm_unit, tbunit.notes from biroekodt.dbo.emp_data as a
		// 						CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
		// 						CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
		// 						,biroekodt.dbo.glo_skpd as b,biroekodt.dbo.glo_org_unitkerja as c,biroekodt.dbo.glo_org_lokasi as d WHERE tbjab.idskpd=b.skpd AND tbjab.idskpd+'::'+tbjab.idunit=c.kd_skpd+'::'+c.kd_unit AND tbjab.idskpd+'::'+tbjab.idlok=d.kd_skpd+'::'+d.kd_lok AND a.sts='1' AND b.sts='1' AND c.sts='1' AND d.sts='1' 
		...
		if ($ids) {
			$data_self = DB::select( DB::raw("  
								SELECT a.id_emp, a.nrk_emp, a.nip_emp, a.nm_emp, tbjab.idjab, tbjab.idunit, tbunit.child, tbunit.nm_unit, tbunit.notes, d.nm_lok, notread.notread, yesread.yesread, lanjut.lanjut from biroekodt.dbo.emp_data as a
								CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
								CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
								CROSS APPLY (
									select  count(disp.rd) as 'notread' from biroekodt.dbo.fr_disposisi disp
									  where rd = 'N' and sts = 1
									  and disp.to_pm = a.id_emp) notread
								CROSS APPLY (
									select  count(disp.rd) as 'yesread' from biroekodt.dbo.fr_disposisi disp
									  where rd = 'Y' and sts = 1
									  and disp.to_pm = a.id_emp) yesread
								CROSS APPLY (
									select  count(disp.rd) as 'lanjut' from biroekodt.dbo.fr_disposisi disp
			...
			$data_self = DB::select( DB::raw("  SELECT a.id_emp, a.nrk_emp, a.nip_emp, a.nm_emp, tbjab.idjab, tbjab.idunit, tbunit.child, tbunit.nm_unit, tbunit.notes, d.nm_lok, notread.notread, yesread.yesread, lanjut.lanjut from biroekodt.dbo.emp_data as a
								CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
								CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
								CROSS APPLY (
									select  count(disp.rd) as 'notread' from biroekodt.dbo.fr_disposisi disp
		...
		$data_stafs = DB::select( DB::raw("  SELECT a.id_emp, a.nrk_emp, a.nip_emp, a.nm_emp, tbjab.idjab, tbjab.idunit, tbunit.child, tbunit.nm_unit, tbunit.notes, d.nm_lok, notread.notread, yesread.yesread, lanjut.lanjut from biroekodt.dbo.emp_data as a
							CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
							CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
							CROSS APPLY (
								select  count(disp.rd) as 'notread' from biroekodt.dbo.fr_disposisi disp
		...
		return view('pages.birekokepegawaian.statusdisposisi')
				->with('access', $access)
				->with('result', $result);
		...
		if (strlen($data_self['idunit']) == 10) {
			...
			$belum = json_decode(json_encode(DB::select( DB::raw("
						...
						FROM biroekodt.dbo.v_disposisi
			...
			$querys = DB::select( DB::raw("  
						SELECT id_emp, nrk_emp, nip_emp, nm_emp, a.idgroup, tgl_lahir, jnkel_emp, tgl_join, status_emp, tbjab.idjab, tbjab.idunit, tbunit.child, tbunit.nm_unit from biroekodt.dbo.emp_data as a
						CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
						CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
						,biroekodt.dbo.glo_skpd as b,biroekodt.dbo.glo_org_unitkerja as c,biroekodt.dbo.glo_org_lokasi as d WHERE tbjab.idskpd=b.skpd AND tbjab.idskpd+'::'+tbjab.idunit=c.kd_skpd+'::'+c.kd_unit AND tbjab.idskpd+'::'+tbjab.idlok=d.kd_skpd+'::'+d.kd_lok AND a.sts='1' AND b.sts='1' AND c.sts='1' AND d.sts='1' 
	...
	public function suratkeluar()
	{
		...
		return view('pages.birekokepegawaian.suratkeluar')
				->with('access', $access)
				->with('surats', $surats);
	}
	...
	public function suratkeluartambah()
	{
		...
		return view('pages.birekokepegawaian.suratkeluartambah')
	...
	public function suratkeluarubah(Request $request)
	{
		...
		return view('pages.birekokepegawaian.suratkeluarubah')
				->with('surat', $surat)
				->with('disposisis', $disposisis)
				->with('dispkodes', $dispkodes);
	}
	...
	{
		$this->checkSessionTime();
		$accessid = $this->checkAccess($_SESSION['biroeko_data']['idgroup'], 1375);
	...
	public function entrikinerja(Request $request)
	{
		...
		// 			SELECT *
		// 			from biroekodt.dbo.kinerja_data
		// 			where idemp = '$idemp'
		// 			and stat is null
		...
		return view('pages.birekokepegawaian.kinerjaentri')
				->with('access', $access)
	...
	public function kinerjatambah(Request $request)
	{
		...
		return view('pages.birekokepegawaian.kinerjatambah')
	...
	public function getaktivitas()
	{
		...
		// 			from biroekodt.dbo.kinerja_data a
		// 			join biroekodt.dbo.kinerja_detail b on b.idemp = a.idemp
		// 			where b.idemp = '$idemp' 
	...
	public function approvekinerja(Request $request)
	{
		...
		if ($_SESSION['biroeko_data']['idunit']) {
			$idunit = $_SESSION['biroeko_data']['idunit'];
		} else {
			$idunit = '01';
		}
		...
		$pegawais = DB::select( DB::raw("
					SELECT id_emp, nm_emp, nrk_emp FROM biroekodt.dbo.emp_data as a
					CROSS APPLY (SELECT TOP 1 tmt_gol,tmt_sk_gol,no_sk_gol,idgol,jns_kp,mk_thn,mk_bln,gambar,nm_pangkat FROM  biroekodt.dbo.emp_gol,biroekodt.dbo.glo_org_golongan WHERE a.id_emp = emp_gol.noid AND emp_gol.idgol=glo_org_golongan.gol AND emp_gol.sts='1' AND glo_org_golongan.sts='1' ORDER BY tmt_gol DESC) tbgol
					CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM  biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
					CROSS APPLY (SELECT TOP 1 iddik,prog_sek,no_sek,th_sek,nm_sek,gelar_dpn_sek,gelar_blk_sek,ijz_cpns,gambar,nm_dik FROM  biroekodt.dbo.emp_dik,biroekodt.dbo.glo_dik WHERE a.id_emp = emp_dik.noid AND emp_dik.iddik=glo_dik.dik AND emp_dik.sts='1' AND glo_dik.sts='1' ORDER BY th_sek DESC) tbdik
					CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
		...
		$laporans = DB::select( DB::raw("
					...
					from biroekodt.dbo.kinerja_data
					join biroekodt.dbo.emp_data on emp_data.id_emp = kinerja_data.idemp
		...
		return view('pages.birekokepegawaian.kinerjaapprove')
				->with('access', $access)
				->with('laporans', $laporans)
	...
	public function getdetailaktivitas(Request $request)
	{
		...
		$query = DB::select( DB::raw("
					SELECT *
					from biroekodt.dbo.kinerja_detail
					where idemp = '$idemp'
					and tgl_trans = '$tgl_trans'
					order by time1
					"));
	...
	public function printexcel(Request $request)
	{
		...
		$now_emp = DB::select( DB::raw("  
				SELECT id_emp, nrk_emp, nip_emp, nm_emp, a.idgroup as idgroup, tgl_lahir, jnkel_emp, tgl_join, status_emp, tbjab.idjab, tbjab.idunit, tbunit.child, tbunit.nm_unit, tbunit.sao, tbunit.notes from biroekodt.dbo.emp_data as a
				CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM  biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
				CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
				,biroekodt.dbo.glo_skpd as b,biroekodt.dbo.glo_org_unitkerja as c,biroekodt.dbo.glo_org_lokasi as d WHERE tbjab.idskpd=b.skpd AND tbjab.idskpd+'::'+tbjab.idunit=c.kd_skpd+'::'+c.kd_unit AND tbjab.idskpd+'::'+tbjab.idlok=d.kd_skpd+'::'+d.kd_lok AND a.sts='1' AND b.sts='1' AND c.sts='1' AND d.sts='1'
		...
		$sheet->setCellValue('A2', 'TENAGA AHLI '.$now_emp['nm_unit'].' BIRO PEREKONOMIAN');
		$sheet->getStyle('A2')->getFont()->setBold( true );
		$sheet->getStyle('A2')->getAlignment()->setHorizontal('center');

		$sheet->mergeCells('A3:E3');
		$sheet->setCellValue('A3', 'BIRO PEREKONOMIAN PROVINSI DKI JAKARTA '.date('Y'));
		...
		$sheet->setCellValue('C6', ': '.ucwords(strtolower($now_emp['nm_unit'])) . ' Biro Perekonomian Provinsi DKI Jakarta');
	...
	public function printexcelpegawai(Request $request)
	{
		...
		$employees = DB::select( DB::raw("  
					SELECT id_emp, nrk_emp, nip_emp, nm_emp, a.idgroup as idgroup, tgl_lahir, jnkel_emp, tgl_join, status_emp, tbjab.idjab, tbjab.idunit, tbunit.nm_unit, tbunit.notes, tbunit.child, d.nm_lok from biroekodt.dbo.emp_data as a
					CROSS APPLY (SELECT TOP 1 tmt_gol,tmt_sk_gol,no_sk_gol,idgol,jns_kp,mk_thn,mk_bln,gambar,nm_pangkat FROM  biroekodt.dbo.emp_gol,biroekodt.dbo.glo_org_golongan WHERE a.id_emp = emp_gol.noid AND emp_gol.idgol=glo_org_golongan.gol AND emp_gol.sts='1' AND glo_org_golongan.sts='1' ORDER BY tmt_gol DESC) tbgol
					CROSS APPLY (SELECT TOP 1 tmt_jab,idskpd,idunit,idlok,tmt_sk_jab,no_sk_jab,jns_jab,replace(idjab,'NA::','') as idjab,eselon,gambar FROM  biroekodt.dbo.emp_jab WHERE a.id_emp=emp_jab.noid AND emp_jab.sts='1' ORDER BY tmt_jab DESC) tbjab
					CROSS APPLY (SELECT TOP 1 iddik,prog_sek,no_sek,th_sek,nm_sek,gelar_dpn_sek,gelar_blk_sek,ijz_cpns,gambar,nm_dik FROM  biroekodt.dbo.emp_dik,biroekodt.dbo.glo_dik WHERE a.id_emp = emp_dik.noid AND emp_dik.iddik=glo_dik.dik AND emp_dik.sts='1' AND glo_dik.sts='1' ORDER BY th_sek DESC) tbdik
					CROSS APPLY (SELECT TOP 1 * FROM biroekodt.dbo.glo_org_unitkerja WHERE glo_org_unitkerja.kd_unit = tbjab.idunit) tbunit
		...
		$sheet->setCellValue('A2', 'BIRO PEREKONOMIAN');
		$sheet->getStyle('A2')->getFont()->setBold( true );
		$sheet->getStyle('A2')->getAlignment()->setHorizontal('center');
		...
		$filename = date('dmy').'_PEGAWAI_BIRO_PEREKONOMIAN.xlsx';
	...
	public function laporankinerja(Request $request)
	{
		...
		return view('pages.birekokepegawaian.kinerjalaporan')
				->with('access', $access)
				->with('pegawais', $pegawais)
				->with('now_id_emp', $now_id_emp)
