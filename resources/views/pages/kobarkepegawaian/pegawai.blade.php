...
@section('css')
	...
	<link rel="stylesheet" href="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/html5-editor/bootstrap-wysihtml5.css') }}" />
	<!-- animation CSS -->
...
@section('js')
    ...
    <script src="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/html5-editor/wysihtml5-0.3.0.js') }}"></script>
    <script src="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/html5-editor/bootstrap-wysihtml5.js') }}"></script>
    <script>
