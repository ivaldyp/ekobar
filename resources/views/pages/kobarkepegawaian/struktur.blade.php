					...
					<div class="panel panel-default">
						...
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
					            ...
					            <!-- <img id="img-overlay" src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/img/profil/organisasi.png') }}" style="width: 100%"> -->
					            <!-- <div id="overlay"></div> -->
					            <span class="zoom" id="ex2">
									<!-- <svgs>       
										<image href="https://mdn.mozillademos.org/files/6457/mdn_logo_only_color.png" height="200" width="200"/>
									</svg> -->
									<a href="/{{ env('APP_NAME') }}/public/img/profil/organisasi2.jpg" target="_blank"><img src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/img/profil/organisasi2.jpg') }}" width='100%' alt='Struktur Organisasi BPAD'/></a>
								</span>
					            <br><br>
					            ...
					            <span class="zoom" id="ex1">
									<a href="/{{ env('APP_NAME') }}/public/img/profil/organisasi_suban2.jpg" target="_blank"><img src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/img/profil/organisasi_suban2.jpg') }}" width='100%' alt='Struktur Organisasi BPAD'/></a>
								</span>
					            <br><br>
...
@section('js')
	...
	<script src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/js/jquery.zoom.js') }}"></script>
	<script src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/js/jquery.zoom.min.js') }}"></script>
