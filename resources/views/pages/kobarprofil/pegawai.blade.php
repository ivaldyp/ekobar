...
@section('css')
	...
	<!-- xeditable css -->
	<link href="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/ample/plugins/bower_components/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css') }}" rel="stylesheet" />
	<!-- animation CSS -->
	...
	<link href="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/ample/plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.css') }}" rel="stylesheet" type="text/css" />
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-md-4">
					<div class="white-box">
								...
								<div class="user-content">
									<!-- <?php if ($emp_data['foto'] && $emp_data['foto'] != '') : ?>
										<?php if ($emp_data['tampilnew'] == 1) : ?>
											<img src="/{{ env('APP_NAME') }}/public/publicimg/{{ $emp_data['foto'] }}" style="height: 150%" class="thumb-lg img-circle" alt="img">
										<?php else : ?>
						...
						<form method="POST" action="/{{ env('APP_NAME') }}/profil/form/ubahidpegawai" data-toggle="validator" enctype="multipart/form-data">
						@csrf
						<div class="user-btm-box" style="text-align: center;">
											...
											@foreach($emp_jab as $key => $jab)
												<tr>
													...
													<td style="vertical-align: middle;">
														...
														{{ ucwords(strtolower($jab['unit']['nm_unit'])) }}
													</td>
													...
													<!-- <?php if ($jab['gambar'] && $jab['gambar'] != '') : ?> 
														<?php if ($jab['gambar'] == 1) : ?>
															<td style="vertical-align: middle;">
																<strong>File</strong>
																<br><a target="_blank" href="/{{ env('APP_NAME') }}/public/publicimg/{{ $jab['gambar'] }}"></a>
															</td>
														<?php else : ?>
															<td style="vertical-align: middle;">
																<strong>File</strong>
			...
			<div id="modal-insert-dik" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/{{ env('APP_NAME') }}/profil/form/tambahdikpegawai" class="form-horizontal" enctype="multipart/form-data">
						@csrf
			...
			<div id="modal-update-dik" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<form method="POST" action="/{{ env('APP_NAME') }}/profil/form/ubahdikpegawai" class="form-horizontal" enctype="multipart/form-data">
						@csrf
							<div class="modal-header">
								<h4 class="modal-title"><b>Ubah Pendidikan</b></h4>
							</div>
			...
			<div class="modal fade" id="modal-delete-dik">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" action="/{{ env('APP_NAME') }}/profil/form/hapusdikpegawai" class="form-horizontal">
                        @csrf
                            <div class="modal-header">
...
@section('js')
	...
	<script src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/ample/plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
	<!-- jQuery x-editable -->
	<script src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/ample/plugins/bower_components/moment/moment.js') }}"></script>
	<script type="text/javascript" src="/{{ env('APP_NAME') }}{{ env('APP_ADD_PUBLIC') }}{{ ('/ample/plugins/bower_components/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js') }}"></script>
