...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-md-12">
					<form class="form-horizontal" method="POST" action="/{{ env('APP_NAME') }}/disposisi/form/ubahdisposisi" data-toggle="validator" enctype="multipart/form-data">
					@csrf
						<div class="panel panel-info">
								...
								<div class="panel-body">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="asal_surat" class="form-control" id="asal_surat" value="{{ $dispmaster['asal_surat'] }}">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="kepada_surat" class="form-control" id="kepada_surat" value="{{ $dispmaster['kepada_surat'] }}">
											</div>
										</div>
							...
							<div class="panel-footer">
								<?php 
									if (Session::get('signdate')) {
										$splitsigndate = explode("::", Session::get('signdate'));
										$signdate = Session::get('signdate');
									} elseif ($signdate) {
										$splitsigndate = explode("::", $signdate);
										$signdate = $signdate;
									}
								...
								@if($dispmaster['status_surat'] == 'd' && isset($_SESSION['biroeko_data']['usname']))
								...
								<a href="/{{ env('APP_NAME') }}/disposisi/formdisposisi?yearnow={{$yearnow}}&signnow={{$signnow}}&monthnow={{$monthnow}}"><button type="button" class="btn btn-default pull-right m-r-10" onclick="goBack()">Kembali</button></a>
		...
		$(function () {
			...
			$('.delete-file').on('click', function () {
				...
				if(confirm("Are you sure you want to delete "+$el.data('nm')+"?")){
					...
					$.ajax({ 
					type: "GET", 
					url: "/disp-biro-eko/disposisi/hapusfiledisposisi",
