...
<head>
	...
	<!-- Footable CSS -->
	<link href="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/footable/css/footable.core.css') }}" rel="stylesheet">
	<link href="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/bootstrap-select/bootstrap-select.min.css') }}" rel="stylesheet" />
	<!-- Menu CSS -->
...
<body class="fix-header">
	...
	<!-- Footable -->
	<script src="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/footable/js/footable.all.min.js') }}"></script>
	<script src="/{{ env('APP_NAME') }}{{ ('/ample/plugins/bower_components/bootstrap-select/bootstrap-select.min.js') }}" type="text/javascript"></script>
	<!--FooTable init-->
	<script src="/{{ env('APP_NAME') }}{{ ('/ample/js/footable-init.js') }}"></script>
	<!--Style Switcher -->
